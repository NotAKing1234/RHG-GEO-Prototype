# Optimization Proposal — run_004 | 2026-06-24

## Executive Summary

This run identified **15 total gaps** across 100 DB-selected Country Inn & Suites URLs: **4 new or newly explicit gaps** and **11 recurring or persistent themes**. The strongest signal is that Radisson has partially improved root crawl access (`/robots.txt` now returns HTTP 200), but the improvement is incomplete: 58 selected pages still return HTTP 403, including all English/US Country Inn brand pages, every selected hotel overview page, and every selected Bathinda hotel subpage. The **top 3 priority changes** are: (1) restore HTTP 200 access for public English/US Country Inn brand and hotel pages; (2) serve public sitemap XML and remove test URLs from run selection; and (3) add Hotel/LodgingBusiness schema plus local, review, amenity, and booking facts to unblocked hotel pages.

## Proposal Entries

### PROP-001 - GAP-001 - run_004_GAP-001
...
### PROP-002 - GAP-002 - run_004_GAP-002
...
### PROP-003 - GAP-003 - run_004_GAP-003
...
### PROP-004 - GAP-004 - run_004_GAP-004
...
### PROP-005 - GAP-005 - run_004_GAP-005
...
### PROP-006 - GAP-006 - run_004_GAP-006
...
### PROP-007 - GAP-007 - run_004_GAP-007
...
### PROP-008 - GAP-008 - run_004_GAP-008
...
### PROP-009 - GAP-009 - run_004_GAP-009
...
### PROP-010 - GAP-010 - run_004_GAP-010
...
### PROP-011 - GAP-011 - run_004_GAP-011
...
### PROP-012 - GAP-012 - run_004_GAP-012
...
### PROP-013 - GAP-013 - run_004_GAP-013
...
### PROP-014 - GAP-014 - run_004_GAP-014
...
### PROP-015 - GAP-015 - run_004_GAP-015
